    ...
    return (
        ...
        >
            <div className="container px-5 mx-auto flex w-full justify-center py-6">
                <div className="bg-secondary text-white shadow-2xl p-10 flex justify-center items-center w-full max-w-md h-full flex-col rounded-md gap-5  ">
                    ...
                    <form onSubmit={handleSubmit} className="grid gap-5 w-full text-lg">
                        <div className="grid gap-2 place-items-start">
                            ...
                            <input className='w-full font-medium text-text p-2 outline-none border-2 border-primary rounded focus-within:border-text'
                        ...
                        <div className="grid gap-2 place-items-start">
                            ...
                            <div className="relative w-full flex">
                                <input className='w-full font-medium text-text p-2 flex outline-none border-2 border-primary rounded focus-within:border-text'
                                    ...
                                    id="password"
                                />
                                <div className="absolute right-3.5 text-xl text-primary-hover cursor-pointer top-3.5 ">
                                    {showPassword ?
                        ...
                        <input disabled={!validInput} type="submit" value={loading ? "Processing.." : "Login"}
                            className={`${validInput ? "bg-primary-hover text-white cursor-pointer hover:bg-primary" : "bg-primary-hover   cursor-not-allowed"}  p-2 text-primary
                                  text-xl font-semibold rounded   `} />
                        <div className="flex justify-between w-full px-1">
                            <h1 className="text-slate-600 font-medium">Don't have an account?</h1>
                            <Link href={"/signup"} className='text-xl font-bold text-primary'>Signup</Link>
                        </div>
                    </form>
                </div>
            </div>
